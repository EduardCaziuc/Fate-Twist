...
class PageController: UIViewController {
    ...
    lazy var storyLabel: UILabel = {
        ...
        label.attributedText = page?.story(attributed: true)
        return label
    }()
    ...
    lazy var secondChoiceButton: UIButton = {
        ...
        let title = self.page?.secondChoice?.title
        let selector = #selector(PageController.loadSecondChoice)
    ...
    override func viewWillLayoutSubviews() {
        ...
        NSLayoutConstraint.activate([
            ...
            firstChoiceButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -60.0)
            ])
        ...
        NSLayoutConstraint.activate([
            ...
            secondChoiceButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -22)
            ])
    }
